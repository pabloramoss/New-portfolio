const config = {
  ...
  project1Description: "App con base de datos en MongoDB el cual consta de un buscador de videos a partir de un canal específico en Youtube.",
  project2Description: "E-commerce de costo cero ya que cuenta con base de datos de productos y ventas realizadas en Google Sheet.",
  project3Description: "Blog propio donde muestro experiencias trabajando con diferentes tecnologías.",
  project4Description: "Portfolio donde muestro mis proyectos.",
  project5Description: "",
  project6Description: "",
